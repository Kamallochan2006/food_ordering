...
import com.example.foodordering.models.Hours
import com.example.foodordering.models.RestaurentModel
import java.text.SimpleDateFormat
import java.util.*

class RestaurantListAdapter(val restaurantList: List<RestaurentModel?>?, val clickListener: MainActivity): RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder>() {
